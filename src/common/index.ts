...
export * from '@common/modules/mongoose/user/user-roles/index';
...
export * from '@common/schemas/mongoose/user/user-permissions/index';
export * from '@common/schemas/mongoose/user/user-role/user-role-listener/index';
export * from '@common/schemas/mongoose/user/user-role/user-role.enum';
export * from '@common/schemas/mongoose/user/user-role/user-role.type';
export * from '@common/schemas/mongoose/user/user-role/user-role.schema';
export * from '@common/schemas/mongoose/user/user-subschemas/user-role/index';
